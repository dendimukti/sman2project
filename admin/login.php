...
<img src="../data/logos2.png" height="30%" width="15%">
<h2>SMA NEGERI 2 MALANG</h2>
<br><br>
    <!--<label class="control-label">Log In</label><br><br>-->
<form class="form-horizontal" method="post">
  <div class="form-group">
    <label for="usn" class="col-md-4 control-label">Username</label>
    <div class="col-md-4">
...
<!--  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-md-offset-4 col-md-4">
    	<input type="submit" value="Sign in" class="btn btn-default" name="login">
    </div>
  </div>
</form>
