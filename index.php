...
<table cellpadding="10">
	<tr>
		<td width="30%" height="100%"><img src="data/logos2.png" width="100%" height="100%"/> &nbsp;&nbsp;</td>
		<td>
			<font color="#FFFFF">
...
<?php
	...
	while($data=mysql_fetch_assoc($que1)){
		...
		echo '<li class="treeview">
          <a href="'.$link.'">';
        echo '<i class="fa fa-circle-o"></i>'.$data['NAMA'];        
...
<img src="data/logos2.png" height="30%" width="30%">
